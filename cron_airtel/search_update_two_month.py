...
query = f"SELECT source_account_number, trans_ref_no, partID, callback, merchant_ref, cycle_count FROM transactions WHERE created_at BETWEEN '2021-10-01 00:00:00' and '2021-11-30 23:59:59' and financial_institution = 'airtel' and status in ('Pending','Submitted') and trans_type = 'charge' and cycle_count <= 6 order by created_at DESC"
